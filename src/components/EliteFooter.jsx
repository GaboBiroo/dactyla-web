  ...
  return (
    <footer id="contato" className="bg-[#0A140E] text-[#E8F0EA] relative overflow-hidden">
      ...
      <motion.div
        ...
        variants={stagger}
        className="border-t border-[#E8F0EA]/5 py-32 px-6 transform-gpu will-change-transform"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          >
            ...
            <motion.a
              ...
              className="group flex items-center justify-between p-6 border border-[#D4AF37]/30 rounded-sm bg-transparent hover:bg-[#D4AF37] transition-all duration-500 transform-gpu"
            >
              <div>
            ...
            <motion.button
              ...
              className="w-full text-left group flex items-center justify-between p-6 border border-[#E8F0EA]/10 rounded-sm hover:border-[#E8F0EA]/25 transition-all duration-500 cursor-pointer transform-gpu"
            >
              <div>
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-6 py-4 group cursor-pointer transform-gpu"
            >
      ...
      <div className="border-t border-[#E8F0EA]/5 py-12 px-6 bg-[#070E0A]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          {/* Social Links (Interactive Executive Modals with Hardware Acceleration) & Legal */}
                ...
                <AnimatePresence>
                  {openDropdown === 'linkedin' && (
                    <motion.div
                      ...
                      className="absolute bottom-full mb-3 left-0 md:left-auto md:right-0 bg-[#0A140E] border border-[#D4AF37]/30 rounded-md shadow-2xl p-3 z-30 min-w-[240px] backdrop-blur-xl transform-gpu will-change-transform"
                    >
