 ...
 * 
 * Dactyla Code (dactyla.com.br)
 * Renderização semântica de alta performance para Lighthouse 90+
 */
    ...
    <main className="min-h-screen bg-[#0A140E] text-[#E8F0EA] font-sans antialiased py-16 px-6 md:py-24">
      <article className="max-w-4xl mx-auto space-y-12">
        ...
        {onBack && (
          <button
            onClick={onBack}
            className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#D4AF37] hover:underline cursor-pointer mb-4"
          >
        ...
        <header className="border-b border-[#28593B]/40 pb-8">
          ...
          <p className="mt-4 text-sm font-mono text-[#E8F0EA]/60">
            Última atualização: 21 de Agosto de 2026 | Versão 1.0 (Dactyla Code - dactyla.com.br)
          </p>
        </header>
